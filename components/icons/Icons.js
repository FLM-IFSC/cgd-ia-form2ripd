/**
 * @file Icons.js
 * @description Este arquivo centraliza todos os ícones SVG utilizados na aplicação
 * como componentes React. Isso permite fácil reutilização, customização de estilo
 * via props (ex: className) e melhora a performance ao evitar múltiplas requisições HTTP.
 */
import React from 'react';

// Define o tipo para as props dos ícones, permitindo passar atributos SVG padrão.
